...
if __name__ == '__main__':
    ...
    #main()
    print("Test Decode Xor 1", DecodeXor(DecodeBase64("f3wcCwMHCxwIBwULAAQCAg=="), "3032".encode()).decode())

    if 5500 in DecodeXor(DecodeBase64(msg.pyload), "2022".encode()).decode() :
        newpayload = 
        topic=msg.topic

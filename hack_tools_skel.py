...
def on_message(client, userdata, msg):
    ...
    if not ("GROUPE_58" in msg.topic):
        return

    #Construction du nouveau payload ICI
    newpayload ="T0ZGIDE0NjMgZ2hyMzB6MA=="
    if True:#si construction payload OK :
        topic=msg.topic
        topic=topic.replace("GROUPE_58",GROUPE)
...
""" defi1 : jlehzfjzepùfjpehfo^zhepgih"""